...
function initTable() {
    ...
    $('#cardTable').bootstrapTable('destroy');
    $("#cardTable").bootstrapTable({
        url: __ROOT__ + 'admin/card/getList', //获取数据的Servlet地址
        striped: true,  //表格显示条纹
...
//                    }
        ...
        columns: [
...

            {
                ...
                align: 'center',
                formatter: function(value,row,index){
                    var d='<a href="#" mce_href="#" data_id="'+row.id+'" data_name="'+row.name+'" data_title="'+row.title+'" data_url="'+row.url+'"  onclick="editcard(this)" >编辑</a> ';
