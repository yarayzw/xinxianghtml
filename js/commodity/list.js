        ...
        columns: [
...

            {
                ...
                formatter: function(value,row,index){
                    ...
                    var e='<a href="#" mce_href="#" " data_url="'+row.view+'/'+row.pc_url+'""  onclick="preview(this)" >预览</a> ';
                    var d='<a href="#" mce_href="#" " data_url="'+row.view+'/'+row.ml_url+'"  onclick="preview(this)" >手机版</a> ';
