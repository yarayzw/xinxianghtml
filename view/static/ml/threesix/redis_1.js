...
function zhuanhua() {
    //获取加密sign
    $.ajax({
        url: base_url + '/thirdparty/api/getRedisPop',
        data: {
            'name': wechat_id,
        },
        method: "POST",
    ...
    var data_ = {
        "data":
            {
                "request_time":1545033743,
                "data_industry":"ocpc_web_convert",
                "data_detail":
                    {
                        "impression_id":"9356596331006111412",
                        "trans_id":"202cb962ac59075b964b07152d234b70",
                        "event":"SUBMIT",
                        "event_time":1545033743
                    }
            }
    };
    $.ajax({
