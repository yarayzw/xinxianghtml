    ...
    return function (e) {
        ...
        function o(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : r,
                n = document.getElementsByTagName("script")[0], o = document.createElement("script");
        ...
        var ae, ce = navigator.userAgent, ue = /(iPad).*OS\s([\d_]+)/.test(ce), le = /(iPod)(.*OS\s([\d_]+))?/.test(ce),
            fe = !ue && /(iPhone\sOS)\s([\d_]+)/.test(ce), se = ue || le || fe,
            pe = /(Android);?[\s\/]+([\d.]+)?/.test(ce), he = /micromessenger/i.test(ce), be = /QQ\/([\d\.]+)/.test(ce),
            ...
            }, Oe = document.querySelector("meta[name=description]"), je = document.querySelector("link[rel*=icon]"),
            Se = {
